package com.example.postservice.core.auth;
...
import com.example.postservice.core.exceptions.auth.UnauthorizedException;
import com.example.postservice.core.helpers.JwtService;
...
public class AuthAspect {
  ...
  @Before("@annotation(com.example.postservice.core.auth.Auth)")
